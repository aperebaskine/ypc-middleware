...
public class TicketServiceTest {
	...
	private void testFindById() 
		...
		t = ticketService.findById(2l, locale);
		if (t == null) {
		...
		t = ticketService.findById(-1l, locale);
		if (t != null) {
		...
		t = ticketService.findById(null, locale);
		if (t != null) {
			logger.error("Se esperaba un ticket nulo, recibido: {}", t);
		} else {
	...
	private void testFindBy()
		...
		results = ticketService.findBy(criteria, locale, 1, 10);
	...
	private void testCreate() 
		...
		if (id == null || !t.getTitle().equals(ticketService.findById(t.getId(), locale).getTitle())) {
